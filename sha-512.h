...
#define SHR(x, n) (0x0 | (x >> n))
#define ROTR(x, n) (SHR(x, n) | (x << (64 - n)))
#define Sigma0(a) (ROTR(a, 28) ^ ROTR(a, 34) ^ ROTR(a, 39))
#define Sigma1(e) (ROTR(e, 14) ^ ROTR(e, 18) ^ ROTR(e, 41))
...
/* boolean if all of file has been read or not */
int file_ended = 0;

/* initialize space for W */
